...
esp_err_t handler_reboot(httpd_req_t *req)
{
    ...
    const char* resp_str = "<h1 style=\"font-size: 22px; font-weight: bold; font-family: monospace; color: #5347AE; margin-block-start: 0.0em; margin-block-end: 0.2em;\">Плата ESP32-CAM перезагрузится в течении 5 секунд!</h1>";
    httpd_resp_send(req, resp_str, strlen(resp_str)); 
