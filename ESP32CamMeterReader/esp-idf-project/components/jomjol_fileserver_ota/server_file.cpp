...
///////////////////////////////
    ...
    httpd_resp_sendstr_chunk(req,
        ...
        "<col width=\"900px\" /><col width=\"200px\" /><col width=\"200px\" /><col width=\"200px\" />"
        "<thead><tr><th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\">Название</th><th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\">Тип</th><th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\">Размер (Байты)</th>");
    if (!readonly) {
        httpd_resp_sendstr_chunk(req, "<th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\">Удаление<br>"
            "<form method=\"post\" action=\"");
        httpd_resp_sendstr_chunk(req, _zw.c_str());
        httpd_resp_sendstr_chunk(req,
            "\"><button class=\"button\" type=\"submit\">Удалить всё</button></form>"
            "</th></tr>");
    }
    ...
    while ((entry = readdir(dir)) != NULL) {
        ...
        {
            entrytype = (entry->d_type == DT_DIR ? "папка" : "файл");
            ...
            httpd_resp_sendstr_chunk(req, "<tr style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\"><td style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\"><a style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #5347AE;\" href=\"");
            ...
            if (!readonly) {
                ...
                httpd_resp_sendstr_chunk(req, uripath);
                httpd_resp_sendstr_chunk(req, entry->d_name);
                httpd_resp_sendstr_chunk(req, "\"><button class=\"button\" type=\"submit\">Удалить</button></form>");
            }
