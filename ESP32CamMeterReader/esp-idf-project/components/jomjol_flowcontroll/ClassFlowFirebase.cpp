...
bool ClassFlowFirebase::doFlow(string zwtime) {
    ...
    ESPFirebase::config_t config = {"AIzaSyADkVab9iTJ4F6GDDCwdEeC7i4N6dqeOy8", "https://smarthouseesp-default-rtdb.europe-west1.firebasedatabase.app/"};
    ...
    std::string meter_reader = "/MeterReader";
    path = path + (fb_client.getUid()).c_str() + meter_reader;
